...
# mean, sd
mean(data_rel$age, na.rm = T)
sd(data_rel$age, na.rm = T)
```
...
# correlations_table_psm_rel = apa.cor.table(correlations_psm_rel, filename = "Table2.doc", table.number = 2)
# 
...
# correlations_table_psm_prefs = apa.cor.table(correlations_psm_prefs, filename = "Table3.doc", table.number = 3)
# 
...
# correlations_table_psm_self = apa.cor.table(correlations_psm_self, filename = "Table4.doc", table.number = 4)
# 
