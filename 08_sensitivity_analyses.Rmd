...
# for d
evalue(MD(-0.37), lo = -0.51, hi = -0.24)

# for confidence limit closer to null
evalue(MD(-0.24))
```
...
```{r}
# for d
evalue(MD(-0.52), lo = -0.66, hi = -0.37)
...
```{r}
# for d
evalue(MD(-0.66), lo = -0.81, hi = -0.51)
...
```{r}
# for d
evalue(MD(-0.16), lo = -0.30, hi = -0.02)
...
```{r}
# for d
evalue(MD(-0.21), lo = -0.35, hi = -0.08)
...
```{r}
# for d
evalue(MD(-0.43), lo = -0.57, hi = -0.29)
...
```{r}
# for d
evalue(MD(-0.49), lo = -0.63, hi = -0.34)
...
```{r}
# for d
evalue(MD(-0.65), lo = -0.79, hi = -0.52)
...
```{r}
# for d
evalue(MD(-0.40), lo = -0.54, hi = -0.25)
...
```{r}
# for d
evalue(MD(-0.45), lo = -0.60, hi = -0.31)
...
```{r}
# for d
evalue(MD(-0.17), lo = -0.31, hi = -0.04)
...
```{r}
# for d
evalue(MD(1.12), lo = 0.93, hi = 1.32)
...
```{r}
# for d
evalue(MD(-0.67), lo = -0.83, hi = -0.51)
...
```{r}
# for d
evalue(MD(-0.46), lo = -0.61, hi = -0.31)
...
#### interest nonmonogamous relationships
```{r}
# for d
evalue(MD(0.20), lo = 0.05, hi = 0.35)
...
```{r}
# for d
evalue(MD(0.57), lo = 0.41, hi = 0.73)
...
```{r}
# for d
evalue(MD(0.61), lo = 0.45, hi = 0.76)
...
```{r}
# for d
evalue(MD(-0.77), lo = -0.94, hi = -0.61)
