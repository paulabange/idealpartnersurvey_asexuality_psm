...
#describeBy(asex_v_umhetero_rel, asex_v_umhetero_rel$sexual_orientation) #@Paula: dataset asex_v_umhetero_rel could not be found
nrow(data_prefs_unmatched)
#describeBy(asex_v_umhetero_prefs, asex_v_umhetero_prefs$sexual_orientation) #@Paula: dataset asex_v_umhetero_rel could not be found
...
fisher_test_asex_v_umhetero_country = fisher.test(matrix_asex_v_umhetero_country, simulate.p.value = TRUE) #@Paula: inserting simulate.p.value = TRUE fixes problem with fishers z test
fisher_test_asex_v_umhetero_country
fisher_test_asex_v_umhetero_country$p.value #@Paula: wrong dataset
```
@Problem Fehlermeldung bei Fisher exact test. N wahrscheinlich zu groß. 
...
library(confintr)
ci_cramersv(matrix_asex_v_umhetero_country, type = "chi-squared") #@Paula: you can get the CI with the function ci_cramersv from the package confintr
```
