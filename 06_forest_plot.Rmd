...
header_rel <- tibble(Preferred_relationship_options = c("", "Preferred relationship options"),
                d = c("", "d"),
                 summary = TRUE)
...
preferred_relationship_options  %>% 
  forestplot(labeltext = c(Preferred_relationship_options, d), 
             ...
             boxsize = .25,
              ...
              xticks = c(-1, -0.5, -0.26,0, .26, .5, 1, 1.2),
             txt_gp = fpTxtGp(ticks=gpar(cex=.75)),
             col = fpColors(box = "royalblue",
                            line = "black",
                            summary = "royalblue"))
```
