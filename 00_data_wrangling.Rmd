...
fulldata_selected_wrangled %>%
  ...
  miss_frac()
```
@PROBLEM: We have 7051 missings here, that did answer the rest of the survey. We did not mention in the preregistration what to do with these cases. NAs seem to caused by a technical bug, therefore all NAs will be included for the analyses.
...
#### Partner preferences
```{r Partner preference dimensions}
