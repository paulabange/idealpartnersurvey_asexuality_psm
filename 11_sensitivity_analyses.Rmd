...
MatchIt objects are needed to calculate Rosenbaum bounds; therefore, matching is run again.
...
### 1. Rosenbaum's sensitivity analysis
...
### 2. E-Value
E-value is calculated for each Cohen's d (for signficant results only) and for its confidence limit that is closer to Null (VanderWeele & Ding, 2017)

#### Relationship options
Extract standard errors for effect estimates (needed for calculating the E-value)
```{r}
# SE = (upper CI limit - d)/1.96

# interest non-sexual relationships
d_rel_nonsexrel = effsize::cohen.d(interest_nonsexrel ~ sexual_orientation, data = nnm_rel_data, paired = T)
se_rel_nonsexrel = (d_rel_nonsexrel$conf.int[[2]] - d_rel_nonsexrel$estimate)/1.96
se_rel_nonsexrel

# interest sexual relationships
d_rel_sexrel = effsize::cohen.d(interest_hookups ~ sexual_orientation, data = nnm_rel_data, paired = T)
se_rel_sexrel = (d_rel_sexrel$conf.int[[2]] - d_rel_sexrel$estimate)/1.96
se_rel_sexrel

# interest monogamous relationships
d_rel_monrel = effsize::cohen.d(interest_monrel ~ sexual_orientation, data = nnm_rel_data, paired = T)
se_rel_monrel = (d_rel_monrel$conf.int[[2]] - d_rel_monrel$estimate)/1.96
se_rel_monrel

# interest non-monogamous relationships
d_rel_nonmonrel = effsize::cohen.d(interest_nonmonrel ~ sexual_orientation, data = nnm_rel_data, paired = T)
se_rel_nonmonrel = (d_rel_nonmonrel$conf.int[[2]] - d_rel_nonmonrel$estimate)/1.96
se_rel_nonmonrel

# interest alternative committed relationships
d_rel_altrel = effsize::cohen.d(interest_altrel ~ sexual_orientation, data = nnm_rel_data, paired = T)
se_rel_altrel = (d_rel_altrel$conf.int[[2]] - d_rel_altrel$estimate)/1.96
se_rel_altrel

# interest single
d_rel_single = effsize::cohen.d(interest_single ~ sexual_orientation, data = nnm_rel_data, paired = T)
se_rel_single = (d_rel_single$conf.int[[2]] - d_rel_single$estimate)/1.96
se_rel_single

# interest parent
d_rel_parent = effsize::cohen.d(interest_parent ~ sexual_orientation, data = nnm_rel_data, paired = T)
...
```{r}
# confident-assertive
d_prefs_ca = effsize::cohen.d(pref_imp_ca ~ sexual_orientation, data = nnm_data, paired = T)
se_prefs_ca = (d_prefs_ca$conf.int[[2]] - d_prefs_ca$estimate)/1.96
se_prefs_ca


# attractive
d_prefs_att = effsize::cohen.d(pref_imp_att ~ sexual_orientation, data = nnm_data, paired = T)
se_prefs_att = (d_prefs_att$conf.int[[2]] - d_prefs_att$estimate)/1.96
se_prefs_att

# sexually expierienced
d_prefs_sexually_experienced = effsize::cohen.d(pref_imp_sexually_experienced ~ sexual_orientation, data = nnm_data, paired = T)
...
# kind-supportive
d_prefs_ks = effsize::cohen.d(pref_imp_ks ~ sexual_orientation, data = nnm_data, paired = T)
se_prefs_ks = (d_prefs_ks$conf.int[[2]] - d_prefs_ks$estimate)/1.96
se_prefs_ks

# financially secure-successful
d_prefs_fs = effsize::cohen.d(pref_imp_fs ~ sexual_orientation, data = nnm_data, paired = T)
...
```{r}
# confident-assertive
d_self_ca = effsize::cohen.d(self_ca ~ sexual_orientation, data = nnm_self_data, paired = T)
se_self_ca = (d_self_ca$conf.int[[2]] - d_self_ca$estimate)/1.96
se_self_ca


# attractive
d_self_att = effsize::cohen.d(self_att ~ sexual_orientation, data = nnm_self_data, paired = T)
se_self_att = (d_self_att$conf.int[[2]] - d_self_att$estimate)/1.96
se_self_att

# sexually expierienced
d_self_sexually_experienced = effsize::cohen.d(self_sexually_experienced ~ sexual_orientation, data = nnm_self_data, paired = T)
...
# kind-supportive
d_self_ks = effsize::cohen.d(self_ks ~ sexual_orientation, data = nnm_self_data, paired = T)
se_self_ks = (d_self_ks$conf.int[[2]] - d_self_ks$estimate)/1.96
se_self_ks

# financially secure-successful
d_self_fs = effsize::cohen.d(self_fs ~ sexual_orientation, data = nnm_self_data, paired = T)
se_self_fs = (d_self_fs$conf.int[[2]] - d_self_fs$estimate)/1.96
se_self_fs

# educated-intelligent
d_self_ei = effsize::cohen.d(self_ei ~ sexual_orientation, data = nnm_self_data, paired = T)
